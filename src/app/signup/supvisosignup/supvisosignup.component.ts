...
//http://localhost:4200/supsignup
@Component({
  selector: 'app-supvisosignup',
  templateUrl: './supvisosignup.component.html',
  styleUrls: ['./supvisosignup.component.css']
})
export class SupvisosignupComponent implements OnInit {
  ...
  onSubmit() {
    ...
    if (this.isWrongExtension) {
      ...
      this.router.navigate(['/supsignup']);
      return;
    }
    ...
    this.isLoading = true;
    const url = 'http://localhost:3080/supsignup';
